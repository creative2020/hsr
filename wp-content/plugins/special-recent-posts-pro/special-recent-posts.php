...
Description: Special Recent Posts PRO is a very powerful plugin/widget which displays your latest posts with thumbnails. <strong>The perfect solution for online magazines or simple blogs, it comes with more than 60+ customization options available.</strong> <strong>To get started: 1)</strong>  Click the "Activate" link to the left of this description. <strong>2)</strong> Go to Settings -> Special Recent Post PRO page and configure the plugin. <strong>3)</strong> Go to the Widgets page and drag the 'Special Recent Posts PRO' widget onto your sidebar and configure its settings. <strong>4)</strong> If you wish to use PHP code or shortcodes for your pages, simply copy and paste the code provided under the panel "Code Generator" in the widget options. Or, alternatively, please refer to the online documentation available at <a href='http://www.specialrecentposts.com/docs' target='_blank'>http://www.specialrecentposts.com/docs</a>. You can also check the readme.txt file for further details. <strong>5)</strong> Enjoy.
Version: 2.5.2
...
define('SRP_PLUGIN_VERSION'      , '2.5.2');                                     // Defining plugin version.
...
| ---------------------------------------------
*/
require_once('srp-defaults.php');                                // Including default config file.
...
/*
| ---------------------------------------------
| External functions to call plugin from PHP
| inline code. Check the manual provided
...
// Adding settings link to wordpress plugin description page.
