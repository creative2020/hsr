...
$srp_default_widget_values = array(
	...
	'author_archive_link'         => 'no',                   // Link author thumbnail to author post archive?
	...
	'post_thumbnail_index_basic'  => 'first',                // (Basic) Select which image in the post content should be picked up.
	'post_thumbnail_index_adv'    => '',                     // (Advanced) Select which image in the post content should be picked up.
	...
	'post_date_prefix'            => '',                     // Default post date PREFIX.
	...
	'category_autofilter'         => 'no',                   // Automatically switch recent posts according to the current category page.
	'category_autofilter_single'  => 'no',                   // Automatically switch recent posts according to the current post's category.
	'category_exclude'            => '',                     // Filter posts by excluding categories IDs.
	'category_title'              => 'no',                   // When filtering by categories, switch the widget title to a linked category title.
	'author_autofilter'           => 'no',                   // Filter automatically posts by the author of the current viewed post/page?
