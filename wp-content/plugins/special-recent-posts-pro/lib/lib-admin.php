...
function srp_admin_setup() {
	...
	// Adding SubMenu Page.
	$srp_settings_page = add_submenu_page('options-general.php', __('Special Recent Posts PRO - Settings Page', 'Special Recent Posts PRO - Settings Page'), __('Special Recent Posts PRO', 'Special Recent Posts PRO'), 'administrator', __FILE__, 'srp_admin_menu_options');
...
?>
	...
	<div class="wrap">
		<div id="srp-admin-container">
			...
			<?php _e('<strong>Welcome to the Special Recent Posts PRO Admin Panel.</strong><br /> In this page you can configure the main settings for the Special Recent Posts PRO plugin. Please keep in mind that these are basic options; special options apply for each widget instance, shortcode or PHP code to ensure an high level of customization. Go to Widget Page and drag the Special Recent Posts PRO widget to see additional options available.', SRP_TRANSLATION_ID); ?>
			</div>
