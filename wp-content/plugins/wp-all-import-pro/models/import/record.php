								...
								if ( ! $missingPosts->isEmpty() ):
									...
									foreach ($missingPosts as $missingPost) {
										...
										if ( ! $this->options['is_update_missing_cf'] and ! $this->options['set_missing_to_draft']){
											...
											if ( $this->options['custom_type'] != "import_users" ) wp_delete_object_term_relationships($missingPost['post_id'], get_object_taxonomies('' != $this->options['custom_type'] ? $this->options['custom_type'] : 'post'));
										}
